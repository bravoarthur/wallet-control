...
export const TradeListContext = createContext<TradeListProps>({} as TradeListProps)
...
export const TradeListProvider = ({children}: TradeListContextProps) => {
    ...
    return(
        ...
        <TradeListContext.Provider value={{tradeList, setTradeList, formDisplay, formHandle, saveTradeList}}>
            {children}
