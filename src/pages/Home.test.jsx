...
describe("Home list", () => {
    ...
    it("Show Ticker in correct Table position", () => {
        ...
        const tickerField = screen.getByRole(
            `tickerField${mockedStockList[0].stockName}`
        );
...
describe("Footer", () => {
    it("Total invested showed properly", () => {
        ...
        //mockedTotal +=1
        expect(totalInvested).toHaveTextContent(
            `$ ${mockedTotal.toLocaleString("pt-BR", {
    ...
    it("Current Total is Showed Properly", () => {
        ...
        //mockedTotal +=1
        expect(currentTotal).toHaveTextContent(
            `$ ${mockedCurrentTotal.toLocaleString("pt-BR", {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            })}`
        );
