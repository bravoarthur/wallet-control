...
function GetPrice() {
    const { stockList, saveList, handleSnackBar } =
    ...
    function getPricesApi() {
        new Promise((resolve, reject) => {
                ...
                Api(item.stockName)
                    .then((resp) => {
                        return {
                            ...
                            currentPrice:
                                resp.price > 0 ? resp.price : item.currentPrice,
            ...
            handleSnackBar({
                status: true,
                severity: "info",
                text: `Prices have Been Refreshed`
            });
    ...
    return (
        <Container>
            <DivApi>
                ...
                <Button variant="outlined" onClick={getPricesApi}>
                    Get Prices{" "}
                </Button>
            </DivApi>
        </Container>
